...
class MiLBLiveManager(BaseMiLBManager, BaseballLive):
    ...
    def _fetch_data(self) -> Optional[Dict]:
        ...
        # For live manager, fetch MiLB API data (not ESPN API)
...
class MiLBRecentManager(BaseMiLBManager, SportsRecent):
    ...
    def _fetch_data(self) -> Optional[Dict]:
        """Fetch data using shared data mechanism or direct fetch for recent."""
        return self._fetch_milb_api_data(use_cache=True)
...
class MiLBUpcomingManager(BaseMiLBManager, SportsUpcoming):
    ...
    def _fetch_data(self) -> Optional[Dict]:
        """Fetch data using shared data mechanism or direct fetch for upcoming."""
        return self._fetch_milb_api_data(use_cache=True)
